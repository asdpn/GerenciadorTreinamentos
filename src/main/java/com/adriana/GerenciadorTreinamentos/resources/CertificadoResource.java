...
public class CertificadoResource {
	...
	public ResponseEntity<Certificado> insert (@RequestBody Certificado obj) {
	...
	public ResponseEntity<Void> update(@RequestBody Certificado obj, @PathVariable Integer id) {
		obj.setId(id);
